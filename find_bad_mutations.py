...
cds_dict = {}
for line in coords:
    cds_line = line.strip().split(" ")[0]
    contig_id = cds_line.split()[0]
    start_position = cds_line.split()[1]
    end_position = cds_line.split()[2]
    strand = cds_line.split()[3]
    protein = cds_line.split()[4]
